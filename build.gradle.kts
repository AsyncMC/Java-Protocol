...
publishing {
    ...
    publications {
        create<MavenPublication>("library") {
            ...
            pom {
                name.set("Bedrock Edition Protocol")
                description.set("An async, non blocking, open source, copyleft Minecraft Bedrock Edition protocol library written in Kotlin")
                url.set("https://github.com/AsyncMC/Bedrock-Protocol")
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/AsyncMC/Bedrock-Protocol")
                    connection.set("scm:git:https://github.com/AsyncMC/Bedrock-Protocol.git")
                    developerConnection.set("https://github.com/AsyncMC/Bedrock-Protocol.git")
                }
            }
        }
    }
